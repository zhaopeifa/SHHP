...
{
    public class AmenitiesSchoolController : ControllerBase
    {
        private ProfileAmenitiesSchoolApp App = new ProfileAmenitiesSchoolApp();
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, string keyword, string cityId, string countyId, string projectId,string
             streetId)
        {
            var data = new
            {
        ...
        public ActionResult SubmitForm(ProfileAmenitiesSchoolEntity WayEntity, string keyValue)
        {
