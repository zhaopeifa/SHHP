...
{
    public class AmenitiesSquareController : ControllerBase
    {
        private ProfileAmenitiesSquareApp App = new ProfileAmenitiesSquareApp();
        ...
        public ActionResult SubmitForm(ProfileAmenitiesSquareEntity WayEntity, string keyValue)
        {
