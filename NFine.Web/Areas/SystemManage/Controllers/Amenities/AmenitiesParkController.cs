...
namespace NFine.Web.Areas.SystemManage.Controllers
{
    ...
    /// 环评-市容-公园
    /// </summary>
    public class AmenitiesParkController : ControllerBase
    {
        private ProfileAmenitiesParkApp App = new ProfileAmenitiesParkApp();
        ...
        public ActionResult SubmitForm(ProfileAmenitiesParkEntity WayEntity, string keyValue)
        {
