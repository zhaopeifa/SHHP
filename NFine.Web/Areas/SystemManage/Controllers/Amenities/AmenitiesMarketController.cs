...
{
    public class AmenitiesMarketController : ControllerBase
    {
        private ProfileAmenitiesMarketApp App = new ProfileAmenitiesMarketApp();
        ...
        public ActionResult SubmitForm(ProfileAmenitiesMarketEntity WayEntity, string keyValue)
        {
