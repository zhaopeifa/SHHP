...
namespace NFine.Web.Areas.SystemManage.Controllers
{
    ...
    /// 环评-环卫-倒粪池小便池
    /// </summary>
    public class SanitationCesspoolController : ControllerBase
    {
        private ProfileSanitationCesspoolApp App = new ProfileSanitationCesspoolApp();
        ...
        public ActionResult SubmitForm(ProfileSanitationCesspoolEntity CessEntity, string keyValue)
        {
            App.SubmitForm(CessEntity, keyValue);
            return Success("操作成功。");
        }
        [HttpPost]
        [HandlerAuthorize(false)]
