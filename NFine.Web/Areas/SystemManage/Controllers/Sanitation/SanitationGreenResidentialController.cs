...
{
    public class SanitationGreenResidentialController : ControllerBase
    {
        private ProfileSanitationGreenResidentialApp App = new ProfileSanitationGreenResidentialApp();
