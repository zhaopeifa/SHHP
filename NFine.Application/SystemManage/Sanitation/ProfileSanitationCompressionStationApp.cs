...
namespace NFine.Application.SystemManage
{
    ...
    /// 环评-环卫-压缩站App
    /// </summary>
    public class ProfileSanitationCompressionStationApp
    {
        private ProfileSanitationCompressionStationRepository service = new ProfileSanitationCompressionStationRepository();
        ...
        /// <returns></returns>
        public List<ProfileSanitationCompressionStationEntity> FildSql(string enCode)
        {
        ...
        /// <returns></returns>
        public List<ProfileSanitationCompressionStationEntity> GetList(Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<ProfileSanitationCompressionStationEntity>();
            if (!string.IsNullOrEmpty(keyword))
            {
                ...
                expression = expression.And(t => t.F_EnCode==intF_Code);
            }
        ...
        /// <returns></returns>
        public List<ProfileSanitationCompressionStationEntity> GetList(Pagination pagination, string keyword, string projectId, string streetId)
        {
            var expression = ExtLinq.True<ProfileSanitationCompressionStationEntity>();
            if (!string.IsNullOrEmpty(keyword))
            {
        ...
        /// <returns></returns>
        public ProfileSanitationCompressionStationEntity GetForm(string keyValue)
        {
        ...
        public void DeleteForm(string keyValue)
        {
            ...
            {
                //添加日志
                LogMess.addLog(DbLogType.Delete.ToString(), "删除成功", "删除环卫压缩站信息【" + GetForm(keyValue).StationName + "】成功！");
            }
            catch { }
        }
